/**
 * Tests for computeSleepPlan and applyDebounce — pure functions
 * that decide when to poll next based on upcoming bucket resets.
 *
...
import { makeBucket, makeState, BASE_INTERVAL_MS, NOW } from './helpers';
